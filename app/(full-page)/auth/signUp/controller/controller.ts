...
export const handleSearchCNPJCreated = async <T extends CreatedAccountEntity>(cnpj: string, setState: React.Dispatch<React.SetStateAction<T>>, setErrors: React.Dispatch<React.SetStateAction<{ [key: string]: string }>>, msgs: any) => {
    try {
