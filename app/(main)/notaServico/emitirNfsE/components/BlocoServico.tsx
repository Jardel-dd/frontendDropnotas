    ...
    return (
        <div className="grid formgrid ">
            ...
            <div className="col-12 mt-1 lg:col-3">
                <Dropdown
                    id="tributacao_issqn"
                    value={nfseGerada.servico.tributacao_issqn ?? ''}
            ...
            <div className="col-12 mt-1 lg:col-3">
             ...
             <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="base_calculo"
                    value={nfseGerada.servico?.valores.base_calculo || ''}
            ...
            <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="aliquota_iss"
                    value={nfseGerada.servico?.valores.aliquota_iss || ''}
                    label="Alíquota ISS"
                    onChange={(e) => handleAllChanges(e, 'servico')}
                    showTopLabel
                    required
              ...
              <div className="col-12 mt-1 lg:col-3">
                <Input
                    ...
                    value={nfseGerada.servico?.valores.aliquota_deducoes || ''}
             ...
             <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="aliquota_pis"
                    value={nfseGerada.servico?.valores.aliquota_pis || ''}
                    label="Alíquota PIS"
                    onChange={(e) => handleAllChanges(e, 'servico')}
                    showTopLabel
                    required
              ...
              <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="aliquota_cofins"
                    value={nfseGerada.servico?.valores.aliquota_cofins || ''}
            ...
            <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="aliquota_inss"
                    value={nfseGerada.servico?.valores.aliquota_inss || ''}
                    label="Alíquota INSS"
                    onChange={(e) => handleAllChanges(e, 'servico')}
                    showTopLabel
                    required
             ...
             <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="aliquota_ir"
                    value={nfseGerada.servico?.valores.aliquota_ir || ''}
                    label="Alíquota IR"
                    onChange={(e) => handleAllChanges(e, 'servico')}
                    showTopLabel
                    required
             ...
             <div className="col-12 mt-1 lg:col-3">
                <Input
                    id="aliquota_csll"
                    value={nfseGerada.servico?.valores.aliquota_csll || ''}
                    label="Alíquota CSLL"
                    onChange={(e) => handleAllChanges(e, 'servico')}
                    showTopLabel
                    required
            ...
            <div className="col-12 mt-1 lg:col-3">
                <Input
                    ...
                    value={nfseGerada.servico?.valores.aliquota_outras_retencoes || ''}
             ...
             <div className="col-12 mt-1 lg:col-3">
                <Input
                    ...
                    value={nfseGerada.servico?.valores.percentual_desconto_incondicionado || ''}
             ...
             <div className="col-12 mt-1 lg:col-3">
                <Input
                    ...
                    value={nfseGerada.servico?.valores.percentual_desconto_condicionado || ''}
